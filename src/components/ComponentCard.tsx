      ...
      {selected && component.status === 'ready' && (
        <div className="pt-3 border-t border-[#3c3c3c]">
          <div className="flex justify-between items-center mb-2">
            <label className="text-xs text-[#858585] font-semibold">Confidence Threshold</label>
            <span className="text-xs font-mono text-white bg-[#3c3c3c] px-2 py-0.5 rounded">{confidence.toFixed(2)}</span>
          </div>
          <input
            type="range"
            min="0"
